...
;--------------------------------------------------------------------------------
; scroll 2 (move bitmap by 1px and insert new characters as needed)
;--------------------------------------------------------------------------------
...
do_scroll2:
            ...
            addq       #1,scroll_x2
            cmp.w      #SCROLL_SIZE_IN_PX,scroll_x2
            bne        .reset_scroll
            clr.w      scroll_x2
.reset_scroll:
            ...
            lea        bpls+SCROLL2_Y*LINE_SIZE,a1
            add.w      bpl_offset,a1
